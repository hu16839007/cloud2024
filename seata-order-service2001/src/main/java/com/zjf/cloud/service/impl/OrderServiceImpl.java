...
import com.zjf.cloud.apis.AccountFeignApi;
import com.zjf.cloud.apis.StorageFeignApi;
import com.zjf.cloud.entities.Order;
import com.zjf.cloud.mapper.OrderMapper;
import com.zjf.cloud.service.OrderService;
    ...
    public void create(Order order) {
        ...
        if (result >0){
            ...
            criteria.andEqualTo("userId",orderFromDB.getUserId())
                    .andEqualTo("status",0);
            int updateResult = orderMapper.updateByExample(orderFromDB, example);
